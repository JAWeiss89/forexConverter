...
app.config['DEBUG_TB_HOSTS'] = ['dont-show-debug-toolbar'] #A hacky way of stopping the debug toolbar from interrupting our tests. Not needed if not using debug toolbar
